...
def get_all_data(symbol):
    ...
    for i in range(2015, 2025):
        # Start and End Dates
        start_date = datetime.datetime(i, 1, 1)  # Replace with your desired start date
        end_date = datetime.datetime(i + 1, 1, 1)  # Replace with your desired end date
...
if __name__ == '__main__':
    ...
    output = get_all_data(sys.argv[1])
    output.to_sql(sys.argv[1], conn, if_exists='replace', index=False)
